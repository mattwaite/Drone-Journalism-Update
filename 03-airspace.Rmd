...
knitr::include_graphics(rep("images/airspace.jpg"))
```
...
```{r, echo=FALSE, out.width = "100%"}
knitr::include_graphics(rep("images/sectional.jpg"))
```

And the most important is the airspace markers on the sectional. 

```{r, echo=FALSE, out.width = "50%"}
knitr::include_graphics(rep("images/sectionaldetail.png"))
```
...
```{r, echo=FALSE, out.width = "100%"}
knitr::include_graphics(rep("images/lincolnsectional.png"))
```
...
```{r, echo=FALSE, out.width = "100%"}
knitr::include_graphics(rep("images/sectionalfraction.png"))
```
...
```{r, echo=FALSE, out.width = "100%"}
knitr::include_graphics(rep("images/moa.png"))
```
...
```{r, echo=FALSE, out.width = "100%"}
knitr::include_graphics(rep("images/otherairspace.png"))
```
